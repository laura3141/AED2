...
public class HashDireta{
    ...
    Jogador tabela[];
    int naoReserva, total, reserva,cReserva;
    ...
    public HashDireta(int reserva, int naoReserva) {
        this.reserva = reserva;
        this.naoReserva = naoReserva;
        this.total =reserva + naoReserva;
    ...
    public int h(Jogador jogador) {
        return jogador.getAltura() % naoReserva;
    }
    public void inserir(Jogador jogador){
        ...
        if(tabela[i]==null){
            ...
            if(cReserva<reserva){
                tabela[naoReserva+cReserva]=jogador;
                cReserva++;
            }
        }
    }
    ...
    public static void main(String[] args) {
        ...
        String id="",nome;
        HashDireta hash=new HashDireta();
        Jogador jogadores[]=new Jogador[4000];
        ...
        do{
            ...
            if(hash.pesquisar(nome)) System.out.print("SIM");
