...
public class QuickP{
    ...
    public void sort(int n,Jogador jogadores[]) {
        quicksort(0, n-1,jogadores);
    }
    //Método para ordenar 10 jogadores por ordem alfabetica do estado de nascimento 
    private void quicksort(int esq, int dir,Jogador jogadores[]) {
        int i = esq, j = dir;
